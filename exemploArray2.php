...
<body>
    ...
    echo "ORIGINAL: ";
    print_r ($estados);
    echo "<hr/>STRTOLOWER: coverte uma string para minusculos<br>";
    for ($i = 0; $i < count($estados); $i++){
        $estados[$i] = strtolower($estados[$i]);
    }
    echo "STRTOLOWER: "; print_r ($estados);
    echo "<hr/>SHIFT: Retira o primeir elemento de um array<br>";
    ...
    echo "<hr/>PUSH: Adicionar um ou mais elementos no final de um array<br>";
    ...
    echo "REVERSE: Ordena um array<br>";
    sort($estados);
